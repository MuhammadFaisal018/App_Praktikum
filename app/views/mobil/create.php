            ...
            <form role="form" action="<?= base_url; ?>/mobil/simpanmobil" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Mobil Masuk..." name="mobil_masuk">

                        <label>Mobil Keluar</label>
                        <input type="text" class="form-control" placeholder="Masukkan Mobil Keluar..." name="mobil_keluar">
                    </div>
                </div>
                <!-- /.card-body -->
