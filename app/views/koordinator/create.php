...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="<?= base_url; ?>/koordinator/simpankoordinator" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        <label>Nama Koordinator</label>
                        <input type="text" class="form-control" placeholder="masukkan nama koordinator..." name="nama_koor">
                    </div>
                    <div class="form-group">
